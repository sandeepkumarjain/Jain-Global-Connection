      ...
      <div className="lg:col-span-8 space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xs font-bold text-slate-900 dark:text-white">
                Share an Update with Jain Community
              </h3>
              <p className="text-[10px] text-slate-400">Post news, temple events, or community thoughts</p>
            </div>
          </div>
          ...
          <form onSubmit={handleCreatePost} className="space-y-3">
            <textarea
              rows={3}
              placeholder="Jai Jinendra! Write your post here..."
              value={postContent}
